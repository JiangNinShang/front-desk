      ...
      <div class="div2">
        <table style="width: 400px;height:130px ">
          ...
          <tr>
            ...
            <td>
              <el-button-group >
                <el-button @click="ss('S')">S</el-button>
                <el-button @click="ss('M')">M</el-button>
                <el-button @click="ss('L')">L</el-button>
                <el-button @click="ss('XL')">XL</el-button>
                <el-button @click="ss('XXL')">XXL</el-button>
              </el-button-group>
            </td>
          </tr>
        </table>
...
export default {
  ...
  methods: {
    ...
    shangpin() {
      ...
      this.$http
        ...
        .then(response => {
          ...
          let url = "/shangpin/findkuanshi?id=" + sid;
          this.$http
            .get(url)
            .then(response => {
              this.kuanshi = response.data;
            })
            .catch(ex => {});
        })
        .catch(ex => {});
    ...
    vv(kuanshiid) {
      this.Commodity.kuanshiid = kuanshiid;
    },
    ss(zhi){
       this.Commodity.chima = zhi;
    }
  },
  mounted() {
    this.shangpin();
